...
.LSEH_end_RC4:
.globl	private_RC4_set_key
.def	private_RC4_set_key;	.scl 2;	.type 32;	.endef
.p2align	4
private_RC4_set_key:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_private_RC4_set_key:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
...
.Lexit_key:
	...
	movq	16(%rsp),%rsi
	.byte	0xf3,0xc3
.LSEH_end_private_RC4_set_key:

.globl	RC4_options
.def	RC4_options;	.scl 2;	.type 32;	.endef
.p2align	4
RC4_options:
	leaq	.Lopts(%rip),%rax
	movl	OPENSSL_ia32cap_P(%rip),%edx
	btl	$20,%edx
	jc	.L8xchar
	btl	$30,%edx
	jnc	.Ldone
