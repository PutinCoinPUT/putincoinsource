...
.def	Camellia_EncryptBlock;	.scl 2;	.type 32;	.endef
.p2align	4
...
.def	Camellia_EncryptBlock_Rounds;	.scl 2;	.type 32;	.endef
.p2align	4
.Lenc_rounds:
...
.def	Camellia_DecryptBlock;	.scl 2;	.type 32;	.endef
.p2align	4
...
.def	Camellia_DecryptBlock_Rounds;	.scl 2;	.type 32;	.endef
.p2align	4
.Ldec_rounds:
...
.globl	Camellia_Ekeygen
.def	Camellia_Ekeygen;	.scl 2;	.type 32;	.endef
.p2align	4
...
.def	Camellia_cbc_encrypt;	.scl 2;	.type 32;	.endef
.p2align	4
...
.def	common_se_handler;	.scl 3;	.type 32;	.endef
.p2align	4
common_se_handler:
	pushq	%rsi
	pushq	%rdi
...
cbc_se_handler:
	...
	leaq	.Lcbc_body(%rip),%r10
	cmpq	%r10,%rbx
	jb	.Lin_cbc_frame_setup

	movq	152(%r8),%rax

	leaq	.Lcbc_abort(%rip),%r10
	cmpq	%r10,%rbx
	jae	.Lin_cbc_prologue


	leaq	.Lcbc_enc_pushf(%rip),%r10
	cmpq	%r10,%rbx
	jbe	.Lin_cbc_no_flag
	leaq	8(%rax),%rax
	leaq	.Lcbc_enc_popf(%rip),%r10
	cmpq	%r10,%rbx
	jb	.Lin_cbc_no_flag
	leaq	-8(%rax),%rax
	leaq	.Lcbc_dec_pushf(%rip),%r10
	cmpq	%r10,%rbx
	jbe	.Lin_cbc_no_flag
	leaq	8(%rax),%rax
	leaq	.Lcbc_dec_popf(%rip),%r10
	cmpq	%r10,%rbx
	jb	.Lin_cbc_no_flag
	leaq	-8(%rax),%rax
...
.byte	9,0,0,0
.rva	common_se_handler
.rva	.Lkey_prologue,.Lkey_epilogue	
